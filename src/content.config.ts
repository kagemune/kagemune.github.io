...
const projects = defineCollection({
    ...
    schema: z.object({
        ...
        tools: z.preprocess(
            ...
            z.array(z.enum(["TypeScript", "LIVE", "HTML", "JavaScript", "React Native", "Backend API", "Node.js", "Docker", "Tailwind","React", "Vite", "Google Sheets API", "AppSheet",]))), // change categories here
        year: z.string().max(4),
